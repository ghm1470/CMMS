...
export class CacheSessionStorageTimestampService {
  private cacheList: KeyValueObservable[] = [];

  // I initialize the sessionStorage service.
  constructor() {
    // load all sessionStorage and set into cache array
  ...
  // I return the sessionStorage item with the given key.
