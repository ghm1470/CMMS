...
export class AssetConsumingReferenceService extends ServiceBase2 {

  constructor(public _HttpClient: HttpClient, public _ServiceConfig: ServiceConfig
  ) {
    super();
    this._objectName = 'part-ACR';
  ...
  getAllByPaginationACR(query: {paging: Paging, totalElements: any, term: string, partId: string}) {
