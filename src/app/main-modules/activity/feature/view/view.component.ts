...
export class ViewComponent extends ActivityBaseComponent implements OnInit, OnDestroy, AfterViewInit {
...
/////////////////////////////////////////////////////////// ghasem
    ...
    saveActivity() {
        if (!this.activity.activityLevelList.some(a => a.existRecipientOrderUser === true)) {
            DefaultNotify.notifyDanger('تعیین   کاربر تکنسین مرحله بعد الزامی است', '', NotiConfig.notifyConfig);
            return;
        }
