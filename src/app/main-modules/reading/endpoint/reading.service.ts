...
export class ReadingService extends ServiceBase2 {
  ...
  getAllByPaginationReading(query: {paging: Paging, totalElements: any, term: string, partId: string}) {
  ...
  deleteReading(query: { readingId: string}) {
