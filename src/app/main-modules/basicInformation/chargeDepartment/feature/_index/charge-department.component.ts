...
@Component({
  ...
  templateUrl: './charge-department.component.html',
  styleUrls: ['./charge-department.component.scss']
})
export class ChargeDepartmentComponent implements OnInit, OnDestroy {
