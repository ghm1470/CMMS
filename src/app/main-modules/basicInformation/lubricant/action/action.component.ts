...
export class ActionComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.entityId) {
      const newUpdateDTO = new LubricantDto.Update();
      newUpdateDTO.title = this.htmlForm.controls.title.value;
      newUpdateDTO.type = this.htmlForm.controls.type.value;
      ...
      const newSaveDTO = new LubricantDto.Create();
      newSaveDTO.title = this.htmlForm.controls.title.value;
      newSaveDTO.type = this.htmlForm.controls.type.value;
